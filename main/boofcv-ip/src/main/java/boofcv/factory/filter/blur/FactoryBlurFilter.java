...
public class FactoryBlurFilter {
	...
	public static <T extends ImageBase<T>> BlurStorageFilter<T> meanExt(ImageType<T> type , int radiusX, int radiusY, ImageBorder<T> border ) {
		BlurStorageFilter<T> filter = new BlurStorageFilter<>("meanExt", type, radiusX, radiusY);
